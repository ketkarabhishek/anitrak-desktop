...
import {List, ListItem, ListItemText, ListItemIcon, Link, Collapse, CssBaseline, Drawer,Divider, Chip} from '@material-ui/core'
import {Dashboard, Search, ViewList, Airplay, WatchLater, PlaylistAddCheck, KeyboardArrowDown, KeyboardArrowUp} from '@material-ui/icons';
    ...
    return(
        <div className={classes.root}>
            ...
            >
                ...
                <Divider/>
                <List>
                    <Link color="textPrimary" underline="none" component={Router} to="/" onClick={e => handleListClick(1)}>
                    ...
                    <Collapse in={open}>
                        <List component="div" disablePadding>
                            <Link color="textPrimary" underline="none" component={Router} to="/library/current" onClick={e => handleListClick(11)}>
                                <ListItem selected={selectedIndex === 11} button style={{paddingLeft: "2em"}}>
                                    <ListItemIcon><Airplay/></ListItemIcon>
                                    <ListItemText primary="Current"></ListItemText>
                                    <Chip label={current} size="small" color="primary"></Chip>
                                </ListItem>
                            </Link>
                            <Link color="textPrimary" underline="none" component={Router} to="/library/completed" onClick={e => handleListClick(22)}>
                                <ListItem selected={selectedIndex === 22} button style={{paddingLeft: "2em"}}>
                            ...
                            <Link color="textPrimary" underline="none" component={Router} to="/library/planned" onClick={e => handleListClick(33)}>
                                <ListItem selected={selectedIndex === 33} button style={{paddingLeft: "2em"}}>
                    ...
                    <Link color="textPrimary" underline="none" component={Router} to="/search" onClick={e => handleListClick(5)}>
